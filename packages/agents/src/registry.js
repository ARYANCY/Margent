...
exports.generateAgentRegistry = generateAgentRegistry;
const index_1 = require("../../shared/src/constants/index");
/**
...
function generateAgentRegistry() {
    ...
    for (let i = 1; i <= index_1.AGENT_DISTRIBUTION.ml; i++) {
    ...
    for (let i = 1; i <= index_1.AGENT_DISTRIBUTION.pytrend; i++) {
    ...
    for (let i = 1; i <= index_1.AGENT_DISTRIBUTION.groq; i++) {
    ...
    for (let i = 1; i <= index_1.AGENT_DISTRIBUTION.qml; i++) {
